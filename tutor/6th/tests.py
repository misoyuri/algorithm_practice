...
class TestHashTable(unittest.TestCase):
    ...
    def test_delitem(self):
        ...
        table2 = HashTable(capacity=64)
        keys = "According to all known laws of aviation, there is no way a bee should be able 2 fly".split(' ')
        pre_solution = [15, HashTable.FREE, HashTable.FREE, HashTable.FREE, HashTable.FREE, HashTable.FREE,         #6
                        HashTable.FREE, HashTable.FREE, HashTable.FREE, HashTable.FREE, HashTable.FREE, 17,         #6
                        HashTable.FREE, 10, HashTable.FREE, HashTable.FREE, HashTable.FREE, HashTable.FREE, 0,      #7
                        HashTable.FREE, HashTable.FREE, HashTable.FREE, HashTable.FREE, HashTable.FREE,             #5
                        HashTable.FREE, 3, HashTable.FREE, HashTable.FREE, 5, HashTable.FREE, HashTable.FREE,       #7
